...
class _HomePageState extends State<HomePage> {
  ...
  void initPref() async {
    await SharedPreferenceWithCacheService().init();
    setState(() {
      isLoadingPref = false;
    });
  }
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  HomeItem(
                    taskList:
                        context.watch<GroupViewModel>().groups[0].taskLists[1],
                  ...
                  HomeItem(
                    taskList:
                        context.watch<GroupViewModel>().groups[0].taskLists[2],
                  ...
                  HomeItem(
                    taskList:
                        context.watch<GroupViewModel>().groups[0].taskLists[3],
                  ...
                  Consumer<GroupViewModel>(
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        TaskList item =
                            groupViewModel.groups[0].taskLists[index];
